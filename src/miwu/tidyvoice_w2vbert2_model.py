...
class TidyVoiceW2VBert2Encoder(nn.Module):
    ...
    def __init__(self, checkpoint, config_directory, adapted_checkpoint=None):
        super().__init__()
    ...
    def _forward_equal(self, waveforms):
        ...
        return self.bottleneck(self.pooling(adapted))
...
def load_tidyvoice_w2vbert2_encoder(
    ...
    return TidyVoiceW2VBert2Encoder(
        checkpoint, config_directory, adapted_checkpoint
    ).eval().to(device)
